...
<header class="header-section">
    <div class="d-flex">
        <div class="main-logo">
            <a class="" href="<?= Url::to(['/main/default/index']) ?>">
        ...
        <div class="mx-auto">
            <ul class="main-menu">
                ...
                <?php else: ?>
                    <li>
                        <a class="<?= $currentController->action->id == 'profile' ? 'active' : '' ?>"
                           href="<?= Url::to(['/main/default/profile', 'username' => Yii::$app->user->identity->name]) ?>">
                            Профиль
                        </a>
                    </li>
                    <li>
                        <a class="<?= $currentController->id == 'notifications' ? 'active' : '' ?>"
                           href="<?= Url::to(['/notifications']) ?>">
                            Уведомления
